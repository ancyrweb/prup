...
export function printHowToAddProject(name: string) {
  ...
  console.log(
    "Ensure the server is running for your machine to communicate with it. Type : "
  );
  console.log("");
  ...
  console.log("");
  console.log(
    chalk.bold("prup projects create-config " + getHostName() + " " + name + "")
  );
  console.log("");
  console.log(chalk.bold(chalk.greenBright("4. Build !")));
  console.log(
    "Open the " +
      chalk.bold("prup.config.js") +
      " file. You will see a " +
      chalk.bold("commands") +
      " entry."
  );
  console.log(
    "Put in here the commands you want to run on your server in order to build the project."
  );
